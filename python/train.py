...
#     }
    ...
    ### Train
    train(df, layer_size=args.layer_size, batch_size=args.batch_size, dropout=args.dropout, l2_reg=args.l2_reg, epochs=args.epochs, patience=args.patience, n_folds=args.n_folds, best_of_n_loops=args.best_of_n_loops, save_folder=save_folder, 
