...
\includegraphics[width=0.24\textwidth]{../figures_gd1_end/scanning_plots_GD1_\arabic{imagenum}.pdf}}
\caption{GD1}
\end{figure}
...
\centering
\forloop{imagenum}{0}{\value{imagenum} < 14}{
\includegraphics[width=0.24\textwidth]{../figures_gd1_end/stars_passing_cut_GD1_\arabic{imagenum}.pdf}}
