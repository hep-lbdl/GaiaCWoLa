...
\includegraphics[width=0.24\textwidth]{../figures_gd1/scanning_plots_GD1_\arabic{imagenum}.pdf}}
\caption{GD1}
\end{figure}
...
\centering
\forloop{imagenum}{0}{\value{imagenum} < 15}{
\includegraphics[width=0.24\textwidth]{../figures_gd1/stars_passing_cut_GD1_\arabic{imagenum}.pdf}}
...
\centering
\forloop{imagenum}{0}{\value{imagenum} < 15}{
\includegraphics[width=0.24\textwidth]{../figures_gd1/stars_passing_cut_rahist_GD1_\arabic{imagenum}.pdf}}
\caption{Stars Passing Cut GD1}
\end{figure}
